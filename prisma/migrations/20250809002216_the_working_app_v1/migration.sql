...
*/
-- DropIndex
DROP INDEX "public"."ConnectedAccount_userId_provider_idx";

-- AlterTable
ALTER TABLE "public"."Settings" ADD COLUMN     "atlassianSyncIntervalMinutes" INTEGER,
ADD COLUMN     "autoPushWorklog" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "googleSyncIntervalMinutes" INTEGER,
ADD COLUMN     "microsoftSyncIntervalMinutes" INTEGER;
